...
<template>
  ...
  >
    <template #left>
      <div px4>
        <NNavbar
          ...
          :placeholder="`${collections?.length ?? '-'} collection in total`"
          mt2
          no-padding
        >
          <div
    ...
    <template #right>
      ...
      <div
        v-else
        class="n-panel-grids-center"
      >
        <div
          class="n-card n-card-base"
          px6
          py2
        >
          <span
